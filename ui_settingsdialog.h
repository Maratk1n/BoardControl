...
public:
    ...
    void setupUi(QDialog *SettingsDialog)
    {
        ...
        parametersBox->setMinimumSize(QSize(220, 0));
        parametersBox->setMaximumSize(QSize(220, 16777215));
        ...
        sizePolicy.setHeightForWidth(additionalOptionsGroupBox->sizePolicy().hasHeightForWidth());
        additionalOptionsGroupBox->setSizePolicy(sizePolicy);
    ...
    void retranslateUi(QDialog *SettingsDialog)
    {
        ...
        applyButton->setText(QApplication::translate("SettingsDialog", "\320\237\321\200\320\270\320\275\321\217\321\202\321\214", nullptr));
